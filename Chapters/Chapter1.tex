...
\]
We stretch vector $\uv$ two times along the line defined by vector $\uv$. What is $-\uv$? Simply reverse the direction. What will be the representation of $\alpha\uv$ for all possible values of $\alpha$? An endless line
...
\noindent Now let us consider two unit vectors
